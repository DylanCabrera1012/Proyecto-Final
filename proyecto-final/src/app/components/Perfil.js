...
function Perfil({nombre, b}) {
    const [perfil, setPerfil] = useState("/1000031564.jpg")
    ...
    return (
        <div className={style.contenedor} id="main-content">
            ...
            <div class={style.iconText}>
                <h2 class="icon-title">{nombre}</h2>
                <p class="icon-text">{b}</p>
                <div className={style.icons}>
                    <a href="https://github.com/DylanCabrera10/inf122">
